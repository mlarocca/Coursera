library(caret)
setwd("C:\\Users\\mlarocca\\Documents\\Dropbox\\Coursera Practical Machine Learning\\project")
...
#crossvTransformed <- predict(preProcValues, crossv)
...
###testing <- as.data.frame(sapply(testing, as.numeric))
...
#in-sample error
combPredOut <- predict(combModFit, crossv_test)
confusionMatrix(combPredOut, crossv_test$classe)
